...
export class EntanglerWrapper {
  ...
  constructor(
    ...
    this.entangledCollection = PublicKey.findProgramAddressSync(
      [Buffer.from(COLLECTION_SEED), id.toBuffer()],
      ENTANGLER_PROGRAM_ID
    )[0];
    this.entangledCollectionMint = PublicKey.findProgramAddressSync(
      [Buffer.from(COLLECTION_MINT_SEED), id.toBuffer()],
      ENTANGLER_PROGRAM_ID
    )[0];
    this.entangledCollectionMasterEdition = PublicKey.findProgramAddressSync(
      [
    ...
    this.entangledCollectionMetadata = PublicKey.findProgramAddressSync(
      [
        Buffer.from("metadata"),
        METADATA_PROGRAM_ID.toBuffer(),
        this.entangledCollectionMint.toBuffer(),
    ...
    this.entangledCollectionMintAccount = PublicKey.findProgramAddressSync(
      [
